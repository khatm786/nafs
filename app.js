...
document.getElementById("alif1").innerHTML=Counter1*14641;

document.getElementById("laa").innerHTML=Counter2;
document.getElementById("laa2").innerHTML=Counter2*439230;

document.getElementById("haa").innerHTML=Counter3;
document.getElementById("haa3").innerHTML=Counter3*117128;

document.getElementById("mim").innerHTML=Counter4;
document.getElementById("mim4").innerHTML=Counter4*585640;

document.getElementById("dal").innerHTML=Counter5;
document.getElementById("dal5").innerHTML=Counter5*58564;

document.getElementById("haae").innerHTML=Counter6;
document.getElementById("haae6").innerHTML=Counter6*73205;

document.getElementById("raa").innerHTML=Counter7;
document.getElementById("raa7").innerHTML=Counter7*2928200;

document.getElementById("baa").innerHTML=Counter8;
document.getElementById("baa8").innerHTML=Counter8*29282;

document.getElementById("ine").innerHTML=Counter9;
document.getElementById("ine9").innerHTML=Counter9*1024870;

document.getElementById("yaa").innerHTML=Counter10;
document.getElementById("yaa10").innerHTML=Counter10*146410;

document.getElementById("noon").innerHTML=Counter11;
document.getElementById("noon11").innerHTML=Counter11*732050;

document.getElementById("kaf").innerHTML=Counter12;
document.getElementById("kaf12").innerHTML=Counter12*292820;


document.getElementById("ouaou").innerHTML=Counter13;
document.getElementById("ouaou13").innerHTML=Counter13*87846;


document.getElementById("sin").innerHTML=Counter14;
document.getElementById("sin14").innerHTML=Counter14*4392300;

document.getElementById("taa").innerHTML=Counter15;
document.getElementById("taa15").innerHTML=Counter15*5856400;

document.getElementById("saad").innerHTML=Counter16;
document.getElementById("saad16").innerHTML=Counter16*878460;

document.getElementById("ttae").innerHTML=Counter17;
document.getElementById("ttae17").innerHTML=Counter17*131769;

document.getElementById("ppaf").innerHTML=Counter18;
document.getElementById("ppaf18").innerHTML=Counter18*1464100;


document.getElementById("ddal").innerHTML=Counter19;
document.getElementById("ddal19").innerHTML=Counter19*10248700;

document.getElementById("gaa").innerHTML=Counter20;
document.getElementById("gaa20").innerHTML=Counter20*13176900;

document.getElementById("daa").innerHTML=Counter21;
document.getElementById("daa21").innerHTML=Counter21*1317690;

document.getElementById("faa").innerHTML=Counter22;
document.getElementById("faa22").innerHTML=Counter22*1171280;

document.getElementById("zay").innerHTML=Counter23;
document.getElementById("zay23").innerHTML=Counter23*102487;

document.getElementById("kha").innerHTML=Counter24;
document.getElementById("kha24").innerHTML=Counter24*8784600;

document.getElementById("chine").innerHTML=Counter25;
document.getElementById("chine25").innerHTML=Counter25*14641000;

document.getElementById("ddda").innerHTML=Counter26;
document.getElementById("ddda26").innerHTML=Counter26*11712800;

document.getElementById("jim").innerHTML=Counter27;
document.getElementById("jim27").innerHTML=Counter27*43923;

document.getElementById("ttta").innerHTML=Counter28;
document.getElementById("ttta28").innerHTML=Counter28*7320500;
...
document.getElementById("best3").innerHTML= Counter1*14641 + Counter2*439230 + Counter3*117128 + Counter4*585640 + Counter5*58564 + Counter6*73205 + Counter7*2928200 + Counter8*29282 + Counter9*1024870 + Counter10*146410 + Counter11*732050 + Counter12*292820 + Counter13*87846 + Counter14*4392300 + Counter15*5856400 + Counter16*878460 + Counter17*131769 + Counter18*1464100 + Counter19*10248700 + Counter20*13176900 + Counter21*1317690 + Counter22*1171280 + Counter23*102487	 + Counter24*8784600 + Counter25*14641000 + Counter26*11712800 + Counter27*43923 + Counter28*7320500  ;
...
var
  ...
  document.getElementById("core3").innerHTML= roma * 8313 ;      
  document.getElementById("core").innerHTML= (roma * 8313)+1 ;      
  document.getElementById("core1").innerHTML= (roma * 8313)-1 ;      
  document.getElementById("core2").innerHTML= (roma * 8313)+2 ;      
  document.getElementById("core4").innerHTML= (roma * 8313)+3 ;      
  ...
  var b9 =    document.getElementById("best3").innerHTML;
   ...
   document.getElementById("n_2").innerHTML=b9*30;
   document.getElementById("n_3").innerHTML=b9*8;
   document.getElementById("n_4").innerHTML=b9*40;
   document.getElementById("n_5").innerHTML=b9*4;
   document.getElementById("n_6").innerHTML=b9*5;
   document.getElementById("n_7").innerHTML=b9*200;
   document.getElementById("n_8").innerHTML=b9*2;
   document.getElementById("n_9").innerHTML=b9*70;
   document.getElementById("n_10").innerHTML=b9*10;
   document.getElementById("n_11").innerHTML=b9*50;
   document.getElementById("n_12").innerHTML=b9*20;
   document.getElementById("n_13").innerHTML=b9*6;
   document.getElementById("n_14").innerHTML=b9*300;
   document.getElementById("n_15").innerHTML=b9*400;
   document.getElementById("n_16").innerHTML=b9*60;
   document.getElementById("n_17").innerHTML=b9*9;
   document.getElementById("n_18").innerHTML=b9*100;
   document.getElementById("n_19").innerHTML=b9*700;
   document.getElementById("n_20").innerHTML=b9*900;
   document.getElementById("n_21").innerHTML=b9*90;
   document.getElementById("n_22").innerHTML=b9*80;
   document.getElementById("n_23").innerHTML=b9*7;
   document.getElementById("n_24").innerHTML=b9*600;
   document.getElementById("n_25").innerHTML=b9*1000;
   document.getElementById("n_26").innerHTML=b9*800;
   document.getElementById("n_27").innerHTML=b9*3;
   document.getElementById("n_28").innerHTML=b9*500;
